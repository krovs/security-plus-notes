...
1. **Social engineering**: Gathering information on an attack by exploiting the weakest part of security, people.
   ...
   2. **Spear phishing**: Attacks that target specific users with inside information.
   3. **Whaling**: An attack on a powerful or wealthy individual like a CEO.
   ...
   11. **Social engineering**: The practice of using social tactics to gain information from people or get people to do something.
...
7. **Internal/external**: Internal is inside the company, can be intentional, unintentional. External is someone outside the company trying to get in.
...
5. **Misconfiguration/weak configuration**: If there is a door left open, hackers will find it.
